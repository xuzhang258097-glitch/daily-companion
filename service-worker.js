...
const CACHE_NAME = 'daily-companion-v8';
const urlsToCache = [
  '/daily-companion/',
  '/daily-companion/index.html',
  '/daily-companion/style.css?v=8',
  '/daily-companion/app.js?v=8',
  '/daily-companion/stories.js?v=8',
  '/daily-companion/knowledge.js?v=8',
  '/daily-companion/sound.js?v=8',
  '/daily-companion/manifest.json?v=8',
